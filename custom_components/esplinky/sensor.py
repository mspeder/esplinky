...
LINKY_MAPPING = {
    ...
    "BASE": {
        "name": "Linky Total Consumption (BASE)", 
    ...
    "HCHP": {
        "name": "Linky Consumption (Peak Hours)", 
        "unit": UnitOfEnergy.KILO_WATT_HOUR, # <-- CHANGED to kWh
        "icon": "mdi:counter",
        "device_class": SensorDeviceClass.ENERGY, 
        "state_class": "total_increasing",
    ...
    "HCHC": {
        "name": "Linky Consumption (Off-Peak Hours)", 
        "unit": UnitOfEnergy.KILO_WATT_HOUR, # <-- CHANGED to kWh
        "icon": "mdi:counter",
        "device_class": SensorDeviceClass.ENERGY, 
        "state_class": "total_increasing",
    ...
    "IINST": {
        "name": "Linky Instantaneous Current (Total)", 
        "unit": "A", 
        "icon": "mdi:flash",
    ...
    "PTEC": {"name": "Linky Current Tariff Period", "unit": None, "icon": "mdi:cash-multiple", "device_class": None, "state_class": None},
    "ADCO": {"name": "Linky Meter Address", "unit": None, "icon": "mdi:identifier", "device_class": None, "state_class": None},
    "OPTARIF": {"name": "Linky Tariff Option", "unit": None, "icon": "mdi:tag", "device_class": None, "state_class": None},
}
